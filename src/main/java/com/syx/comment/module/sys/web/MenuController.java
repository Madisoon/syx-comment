...
public class MenuController {
    ...
    public String insertModule(@RequestParam("module_value") String moduleValue,
        ...
        String result = menuManageService.insertModule(moduleValue, moduleUrl, moduleId).toString();
        return result;
    }
    ...
    public String getAllModule() {
        String result = menuManageService.getAllModule().toString();
        return result;
    }
    ...
    public String deleteModule(@RequestParam("module_id") String moduleId) {
        String result = menuManageService.deleteModule(moduleId).toString();
        return result;
    }
    ...
    public String getAllSecondModule(@RequestParam("module_id") String moduleId) {
        String result = menuManageService.getAllSecondModule(moduleId).toString();
        return result;
    }
    ...
    public String updateModuleInfo(@RequestParam("module_id") String moduleId,
        ...
        String result = menuManageService.updateModuleInfo(moduleId, moduleName, moduleContent).toString();
        return result;
    }
}
